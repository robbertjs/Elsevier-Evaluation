#!/bin/sh
#SBATCH -p gpu
#SBATCH --job-name=colqwen2text
#SBATCH --mem=30G
#SBATCH --array=1-4
#SBATCH --time=80:00:00
#SBATCH --output=/ivi/ilps/personal/jqiao/colpali/log3/rq3_colqwen2_text%A_%a.output
#SBATCH --error=/ivi/ilps/personal/jqiao/colpali/log3/rq3_colqwen2_text%A_%a.output
