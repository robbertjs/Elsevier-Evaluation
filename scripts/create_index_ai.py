...
test_set_500 = load_dataset('vidore/syntheticDocQA_artificial_intelligence_test', split='test')
test_set_500_ocr = load_dataset('vidore/syntheticDocQA_artificial_intelligence_test_tesseract', split='test')
