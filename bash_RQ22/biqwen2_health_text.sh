...
#SBATCH --array=1-5
#SBATCH --output=/ivi/ilps/personal/jqiao/colpali/log2/biqwen2_pdfvqa_text%A_%a.log
#SBATCH --error=/ivi/ilps/personal/jqiao/colpali/log2/biqwen2_pdfvqa_text%A_%a.log
