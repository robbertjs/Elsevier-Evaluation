...
#SBATCH --array=1-5
#SBATCH --output=/ivi/ilps/personal/jqiao/colpali/log2/biqwen2_arxivqa_screenshot%A_%a.log
#SBATCH --error=/ivi/ilps/personal/jqiao/colpali/log2/biqwen2_arxivqa_screenshot%A_%a.log
#SBATCH --gres=gpu:nvidia_rtx_a6000:1   # Request one GPU per task

declare -a IndexSizes=("0.5k" "2.5k" "5k" "7.5k" "10k")
