...
#SBATCH --array=1-2
#SBATCH --output=/ivi/ilps/personal/jqiao/colpali/log2/dseqwen2_ai_screenshot%A_%a.log
#SBATCH --error=/ivi/ilps/personal/jqiao/colpali/log2/dseqwen2_ai_screenshot%A_%a.log
