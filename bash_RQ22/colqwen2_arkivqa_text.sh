...
#SBATCH --array=1-6
#SBATCH --output=/ivi/ilps/personal/jqiao/colpali/log2/colqwen2_ai_text_%A_%a.log
#SBATCH --error=/ivi/ilps/personal/jqiao/colpali/log2/colqwen2_ai_text_%A_%a.log
