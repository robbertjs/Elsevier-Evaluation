...
#SBATCH --array=1-6
#SBATCH --output=/ivi/ilps/personal/jqiao/colpali/log/colqwen2_pdfvqa_screenshot%A_%a.log
#SBATCH --error=/ivi/ilps/personal/jqiao/colpali/log/colqwen2_pdfvqa_screenshot%A_%a.log
