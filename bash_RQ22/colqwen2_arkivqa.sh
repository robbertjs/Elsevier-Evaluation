#!/bin/sh
#SBATCH -p gpu
#SBATCH --job-name=colqwen2_arxivqa
#SBATCH --mem=30G
#SBATCH --time=15:00:00
#SBATCH --array=1-6
#SBATCH --output=/ivi/ilps/personal/jqiao/colpali/log2/colqwen2_arxivqa_screenshot%A_%a.log
#SBATCH --error=/ivi/ilps/personal/jqiao/colpali/log2/colqwen2_arxivqa_screenshot%A_%a.log
