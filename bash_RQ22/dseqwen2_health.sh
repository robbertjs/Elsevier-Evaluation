...
#SBATCH --array=1-5
#SBATCH --output=/ivi/ilps/personal/jqiao/colpali/log2/dseqwen2_pdfvqa_screenshot%A_%a.log
#SBATCH --error=/ivi/ilps/personal/jqiao/colpali/log2/dseqwen2_pdfvqa_screenshot%A_%a.log
